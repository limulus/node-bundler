...
var Installer = module.exports = function (targetPath, versionSelector, opts) {
  ...
  this._srcDir = Promise.join(this._downloadCacheDirForVersion, this._srcFileName, function (cacheDir, srcFileName) {
    return new Promise(function (resolve, reject) {
      var srcFilePath = path.resolve(cacheDir, srcFileName)
...
Installer.prototype.install = function (installPath, cb) {
  Promise.join(this._version, this._installerFile, this._srcDir, function (version, installerFile, srcDir) {
